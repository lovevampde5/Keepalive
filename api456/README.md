...
针对 [https://api456.me/](https://api456.me/) 中转站的自动签到脚本，支持多账号、SOCKS5 代理和 Telegram 通知。
...
| `SOCKS5_PROXY` | SOCKS5 代理，可多个（换行或逗号分隔） | 可选 |
...
| 错误 | 原因与处理 |
|------|-----------|
| 响应被 WAF 拦截 | 当前 IP 或代理不可用，请检查/更换 `SOCKS5_PROXY` |
| 用户名或密码错误 | 确认账号密码正确 |
